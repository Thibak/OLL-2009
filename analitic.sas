...
/*data gnz_p;*/
/*	set tmp;*/
/*	if reg = 1 then output;*/
/*run;*/
/**/
/*proc sort data = gnz_p;*/
/*	by pt_id;*/
/*run;*/
/**/
/*proc print data = gnz_p;*/
/*	var pt_id name new_normkariotip;*/
/*	   title 'Пациенты из ГНЦ';*/
/*run;*/
/**/
/*data gnz_p;*/
/*	set tmp;*/
/*	if reg = 1 and new_normkariotip = . then output;*/
/*run;*/
/**/
/*proc sort data = gnz_p;*/
/*	by pt_id;*/
